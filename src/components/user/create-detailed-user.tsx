...
const CreateDetailedUser = (props: any) => {
  ...
  let items = [
    ...
    },
    {
      ...
      error: {
        minLength: {
          value: 50,
          message: 'Your bio should have at least 20 characters',
        },
        maxLength: {
          value: 300,
          message: 'Your bio should have no more than 300 characters',
        },
      },
      name: 'bio',
      type: 'text',
    ...
    },
    {
      ...
      error: {
        minLength: {
          value: 20,
          message: 'Your address should have at least 20 characters',
        },
        maxLength: {
          value: 300,
          message: 'Your address should have no more than 300 characters',
        },
      },
      name: 'address',
      type: 'text',
...
export default CreateDetailedUser;
